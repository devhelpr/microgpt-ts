...
export const nl: LocaleStrings = {
  ...
  dialogs: {
    ...
    transformer: {
      ...
      intro: 'De data stroomt <strong class="text-neon">van boven naar beneden</strong>. We beginnen met “welk teken?” en “waar in de sequentie?”, zetten die om in vectoren, combineren en normaliseren, en voeren dat door het transformerblok (attention + kleine MLP). Uiteindelijk krijgen we scores voor het volgende teken.',
      oneForwardPassNote: 'Dit is één “forward pass” voor een enkele positie; dezelfde structuur herhaalt zich voor elk teken dat het model voorspelt.',
    },
  },
  samplePlaceholder: '...',
