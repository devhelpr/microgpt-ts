  ...
  return `
    <div class="panel p-4">
      ...
      <div class="mt-3 space-y-2 text-sm">
        <div class="rounded-lg border border-white/10 bg-black/25 p-2"><span class="text-white/60">${t.breakdown.contextText}</span> <span id="traceContextText" class="mono text-white/90"></span></div>
        ...
        <div class="rounded-lg border border-white/10 bg-black/25 p-2">
          <span class="text-white/60">${t.breakdown.contextTokens}</span>
          <span class="text-white/40 text-xs">${t.breakdown.contextTokensBosHint}</span>
          <br/>
          <span id="traceTokens" class="mono text-white/90"></span>
        </div>
