...
type TransformerDiagramLocale = Pick<
  LocaleStrings,
  "mermaid" | "transformerDiagramExplainers"
>;
    ...
    nodes: [
      {
        data: {
          id: "A",
          label: `${M.whichCharacter} ${INFO_ICON}`,
          explainer: E.A,
        },
      },
      {
        data: {
          id: "B",
          label: `${M.turnCharIntoVector} ${INFO_ICON}`,
          explainer: E.B,
        },
      },
      {
        data: {
          id: "C",
          label: `${M.whichPosition} ${INFO_ICON}`,
          explainer: E.C,
        },
      },
      {
        data: {
          id: "D",
          label: `${M.addPositionAsVector} ${INFO_ICON}`,
          explainer: E.D,
        },
      },
      {
      ...
      },
      {
        data: {
          id: "F",
          label: `${M.stabilizeScale} ${INFO_ICON}`,
          explainer: E.F,
        },
      },
      { data: { id: "TB", label: "" } },
      ...
      },
      {
        data: {
          id: "G2",
          label: `${M.attentionMixContext} ${INFO_ICON}`,
          explainer: E.G2,
          parent: "TB",
        },
      },
      ...
      },
      {
        data: {
          id: "G5",
          label: `${M.smallFeedForward} ${INFO_ICON}`,
          explainer: E.G5,
          parent: "TB",
        },
      },
      ...
      },
      {
        data: {
          id: "H",
          label: `${M.predictNextChar} ${INFO_ICON}`,
          explainer: E.H,
        },
      },
      {
        data: {
          id: "I",
          label: `${M.scoresForEachChar} ${INFO_ICON}`,
          explainer: E.I,
        },
      },
    ],
...
function createPopup(container: HTMLElement): {
